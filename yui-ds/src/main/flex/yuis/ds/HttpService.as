...
package yuis.ds {
    ...
    public dynamic class HttpService extends HTTPMultiService implements IManagedService
    {
        ...
        protected function internalInvoke(operationName:String,args:Array):DsPendingCall{
            ...
            result.yuis_internal::setInternalAsyncToken(asyncToken,getOperation(operationName));
