...
package yuis.ds.responder {
    ...
    public final class RpcEventResponder extends AbstractRpcEventResponder {
        ...
        public override function result(data:Object):void
        {
            ...
            var newEvent:yuis.service.event.ResultEvent = new yuis.service.event.ResultEvent(result);
        ...
        public override function fault(info:Object):void
        {
            if( faultFunction != null ){
                ...
                var newEvent:yuis.service.event.FaultEvent = new yuis.service.event.FaultEvent(faultStatus);
